#ifndef SERVERSKT_HPP
#define SERVERSKT_HPP
...
class LIBNET_EXPORT ServerSkt : public QObject
{
...
class LIBNET_EXPORT ServerSktTcp : public ServerSkt
{
...
class LIBNET_EXPORT ServerSktUdp : public ServerSkt
{
  typedef struct _Conn
  {
    QHostAddress addr;
